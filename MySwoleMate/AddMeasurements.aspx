<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MySwoleMate.Master" AutoEventWireup="true" CodeBehind="AddMeasurements.aspx.cs" Inherits="MySwoleMate.AddMeasurements" %>
    ...
    <div class="container">
      ...
      <div class="form-horizontal">
         <div class="form-group">
          <asp:Label ID="TraineeIDLabel" runat="server" Text="TraineeID" AssociatedControlID="TraineeID" CssClass="col-xs-4 control-label"></asp:Label>
          <div class="col-xs-4">
            <asp:TextBox ID="TraineeID" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-xs-4 col-xs-offset-4">
            <asp:Button ID="AddMeasurementButton" runat="server" Text="Submit" CssClass="btn btn-success" OnClick="AddMeasurementButton_Click" ValidationGroup="AllValidators" />
