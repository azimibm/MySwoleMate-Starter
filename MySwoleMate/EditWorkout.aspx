 ...
 ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
        ...
        <div class="form-group">
          ...
          <div class="col-xs-4">
            ...
            <div class="has-error">
              <span class="help-block">
               <asp:RequiredFieldValidator ID="Exercise1Required" runat="server" ErrorMessage="Step-1-Exercise is Required" ControlToValidate="Exercise1" Display="Dynamic" ValidationGroup="AllValidators"></asp:RequiredFieldValidator>
              </span>
            </div>
          </div>
        </div>
          ...
          <div class="col-xs-2"> 
            ...
            <div class="has-error">
              <span class="help-block">
                ...
                <asp:RangeValidator ID="Set1Validator" runat="server" ControlToValidate="Exercise1Sets" Display="Dynamic" ValidationGroup="AllValidators" MinimumValue="1" MaximumValue="999" ErrorMessage="Please enter a number representing number of sets" Type="Integer"></asp:RangeValidator>
              </span>
            </div>
          </div>
        ...
        <div class="form-group">
        <asp:Label ID="Exercise4Label" runat="server" Text="Step-3-Exercise" AssociatedControlID="Exercise4" CssClass="col-xs-4 control-label"></asp:Label>
        <div class="col-xs-4"> 
        ...
        <div class="form-group">
        <asp:Label ID="Exercise5Label" runat="server" Text="Step-3-Exercise" AssociatedControlID="Exercise5" CssClass="col-xs-4 control-label"></asp:Label>
        <div class="col-xs-4"> 
